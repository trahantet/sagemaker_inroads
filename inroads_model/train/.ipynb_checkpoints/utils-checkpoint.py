...
def upload_lookup_table(Key_path = 'data/Vectorized/combined_vectorized.csv'):
    s3 = boto3.client('s3')
    s3.put_object(Bucket='inroads-test-bucket1',Key='data/Vectorized/combined_vectorized.csv', Body= 'inroads.pkl')
